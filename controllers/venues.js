...
// exports.ask_venue = async (req, res) => {
    ...
    if (err) {
      ...
      if (req.file == undefined) {
        ...
        req.body.airCondition
          ? features.push("Centralized AirCondition")
          : (req.body.airCondition = false);
        req.body.stage ? features.push("Stage") : (req.body.stage = false);
        req.body.screening
          ? features.push("Screening")
          : (req.body.screening = false);
        req.body.stageDecoration
          ? features.push("Stage Decoration")
          : (req.body.stageDecoration = false);
        req.body.highSecurity
          ? features.push("High Security")
          : (req.body.highSecurity = false);
        req.body.groomPhotographyArea
          ? features.push("Rooms")
          : (req.body.groomPhotographyArea = false);
        req.body.easyCentralLocation
          ? features.push("Groom/Briddle Photography Area")
          : (req.body.easyCentralLocation = false);
        req.body.separateSpace
          ? features.push("Easy Central Location")
          : (req.body.separateSpace = false);
        req.body.canBringOwnCarterers
          ? features.push("can bring their own carterers")
          : (req.body.canBringOwnCarterers = false);

        //allowed events
        req.body.artExhibitions
          ? allowedEvents.push("Art Exhibitions")
          : (req.body.artExhibitions = false);
        req.body.popups
          ? allowedEvents.push("Pop-Ups")
          : (req.body.popups = false);
        req.body.promoters
          ? allowedEvents.push("Promoters")
          : (req.body.promoters = false);
        req.body.ticketedEvents
          ? allowedEvents.push("Ticketed events")
          : (req.body.ticketedEvents = false);
        req.body.amplifiedEvents
          ? allowedEvents.push("Amplified Events")
          : (req.body.amplifiedEvents = false);
        req.body.ownMusic
          ? allowedEvents.push("Own Music")
          : (req.body.ownMusic = false);
        req.body.birthdayParties
          ? allowedEvents.push("Birthday Parties")
          : (req.body.birthdayParties = false);
        req.body.weddings
